      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">
            <li><a href="<?php echo site_url('cindex_logistik'); ?>"> <i class="icon-home"></i>Home</a></li>
            <li><a href="<?php echo site_url('cinvlogistik'); ?>"> <i class="icon-grid"></i>Dafatr Inventaris</a></li>
          </ul>
        </div>
      </div>
    </nav>
