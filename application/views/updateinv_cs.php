        ...
        <div class="container-fluid">
          <div class="col-lg-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form class="form-horizontal" method="POST" action="<?php echo site_url('cinv/updateinv/'.$inventaris['idinventaris']);?>">
                    <div class="form-group row">
                      <label class="col-sm-2 form-control-label">Id Inventaris</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="idinventaris" value="<?php echo $inventaris['idinventaris']; ?>">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="nama_inv" value="<?php echo $inventaris['nama_inv']; ?>">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
