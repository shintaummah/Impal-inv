      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center"><img src="img/avatar-7.jpg" alt="person" class="img-fluid rounded-circle">
            <h2 class="h5">Nama USER</h2><span></span>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">
            <li><a href="<?php echo site_url('cindex_peminjam'); ?>"> <i class="icon-home"></i>Home</a></li>
            <li><a href="<?php echo site_url('cinvpinjaman'); ?>"> <i class="icon-grid"></i>Dafatr Inventaris</a></li>
            <li><a href="<?php echo site_url('cpinjaman'); ?>"> <i class="icon-grid"></i>Pinjaman</a></li>
            <li><a href="<?php echo site_url('cpinjaman/add'); ?>"> <i class="icon-grid"></i>Form Pinjaman</a></li>
          </ul>
        </div>
      </div>
    </nav>
