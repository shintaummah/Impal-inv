          ...
          <div class="col-lg-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form class="form-horizontal" method="POST" action="<?php echo site_url('cpinjaman/addProses');?>">
                    <div class="form-group row">
                      <label class="col-sm-2 form-control-label">Id Pinjaman</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="idpinjaman" placeholder="Enter Id Pinjamn">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" name="tglpinjam" placeholder="">
                            </div>
                    </div>
                    <div class="form-group row">
                            <label class="col-sm-2 form-control-label">Tgl Kembali</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" name="tglkembali" placeholder="">
                            </div>
                    </div>
